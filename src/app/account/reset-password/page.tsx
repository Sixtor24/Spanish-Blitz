    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-6 sm:p-8 border border-slate-100 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Password Reset!</h1>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-6 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 text-center">Reset Password</h1>
        <p className="text-sm sm:text-base text-gray-600 mb-6 text-center">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-white text-gray-900 px-4 py-3 pr-10 text-base sm:text-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div className="mt-6 text-center">
            <Link to="/account/signin" className="text-sm sm:text-base text-blue-600 hover:text-blue-700 font-medium transition-colors">
              Back to Sign In
            </Link>
          </div>
        </div>
